...
require( get_template_directory() . '/shortcode/room.php' );
...
function rk_enqueue_styles() {
    ...
    wp_register_style( 'rk-style', get_stylesheet_directory_uri() . '/assets/css/style.css', [], '0.0.2' );
    ...
    wp_enqueue_script('rk-lenis', get_template_directory_uri() . '/assets/vendor/lenis/lenis.min.js', array('jquery'), '0.0.1', true);
